...
\begin{document}
    ...
    As a part of this work, we evaluate whether it is possible to decide the favorable analysis direction in \code{FlowDroid} on the same app in \autoref{s:realworld}.
