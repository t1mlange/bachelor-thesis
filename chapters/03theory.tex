...
\begin{document}
    ...
    For call statements, we have statements of the structure $o.m(a_0, ..., a_n)$ with $n \in \mathbb{N}$. $a_i$ denotes the $i$-th argument and $p_i$ denotes the $i$-th parameter.
    ...
    \begin{itemize}
        \item[] \textbf{Rule 2:} An incoming taint $t = o.h^k$ with $k \geq 0$ produces the outflowing taint set $T = \{\mathit{this}.h^k\}$. 
    \end{itemize}
    ...
    \begin{itemize}
        \item[] \textbf{Rule 4:} An incoming taint $t = x.h^k$ with $k \geq 0$ produces the outflowing taint set $T = \left\{r_i.h^k \mid 0 \leq i \leq n \right\}$. 
    \end{itemize}
