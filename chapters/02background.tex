...
\begin{document}
    ...
    \footnotetext{Program slicing identifies a slice, a subset of the programs statements, which influence a statement (backward pass) or are influenced by a statement (forward pass).}
