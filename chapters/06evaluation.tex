...
\begin{document}
    ...
    We noticed the overtainting in \code{PrivateDataLeak3} is caused by the Easy Taint Wrapper, thus we now compare how using the Summary Taint Wrapper lowers the edge propagations.
