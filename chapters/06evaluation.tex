...
\begin{document}
    ...
    \footnotesize
    \newcommand{\tsubEight}[1]{\hiderowcolors\rowcolor{gray!50}\multicolumn{9}{c}{#1}\\\showrowcolors\hline}
    \rowcolors{2}{gray!25}{white}
    \begin{longtable}{l | r | r | r | r | r | r | r | r}
        \rowcolor{gray!50}& \multicolumn{2}{c|}{\cellcolor{gray!50}{\textbf{Forwards}}} & \multicolumn{2}{c|}{\textbf{Backwards}} & \multicolumn{4}{c}{\textbf{Difference}}\\
        \rowcolor{gray!50}\multirow{-2}{*}{\cellcolor{gray!50}\textbf{App Name}} & \textbf{\#I} & \textbf{\#A} & \textbf{\#I} & \textbf{\#A} & \textbf{\#I} & \textbf{\#A}& \textbf{Total} & \textbf{Relative}\\
        \hline
        \hline
        \endhead
        ...
        $\varnothing$ without Implicit & $70.61$ & $22.46$ & $60.56$ & $40.1$ & $-10.05$ & $17.63$ & $7.59$ & $1.34$\\
    ...
    Summarized, our implementation suffers mostly from additional sinks.
    ...
    \rowcolors{2}{gray!25}{white}
    \begin{longtable}{l | r | r | r | r | r | r | r | r}
        \rowcolor{gray!50} & \multicolumn{2}{c|}{\textbf{EasyTW}} & \multicolumn{2}{c|}{\textbf{SummaryTW}} & \multicolumn{4}{c}{\textbf{Difference}}\\
        \rowcolor{gray!50}\multirow{-2}{*}{\textbf{App Name}} & \textbf{\#I} & \textbf{\#A} & \textbf{\#I} & \textbf{\#A} & \textbf{\#I} & \textbf{\#A}& \textbf{Total} & \textbf{Relative}\\
        \hline\hline
        \endhead
        \tsubEight{AliasingTest}
    ...
    \begin{table}[tbp]
        ...
        \rowcolors{2}{gray!25}{white}
        \begin{tabular}{l | l}
            \rowcolor{gray!50}\textbf{Option} & \textbf{Value}\\
            \hline\hline
    ...
    \begin{table}[tbp]
        ...
        \rowcolors{2}{gray!25}{white}
        \begin{tabular}{l | l}
            \rowcolor{gray!50}\textbf{Class} & \textbf{Method}\\
            \hline\hline
            java.net.URL & set()\\
            & openConnection()\\
            \hline
