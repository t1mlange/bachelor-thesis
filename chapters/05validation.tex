...
\begin{document}
    ...
    Forwards and backwards analysis are not exactly the same. In some cases the results might differ because of limitations or differences in the implementation. In the following textbfs, we provide rationale for these differences.
    ...
    \begin{longtable}{l | l | l}% begin droidbench
        ...
        \fp &$ 14 $&$ 16 $\\
        \fn &$ 9 $&$ 12 $\\
        Precision & $ 88.33 \%$ & $ 86.44 \%$\\
        Recall & $ 92.17 \% $ & $ 89.47 \%$\\
        F1 measure & $ 0.9 $ & $ 0.88 $\\
    \end{longtable} % end droidbench
    ...
    \textbf{ActivityEventSequence2}

    \textbf{ActivityEventSequence3}

    \textbf{BroadcastReceiverLifecycle3}

    \subsubsection{General Java}
    \textbf{StaticInitialization1}

    \textbf{StaticInitialization2}

    \textbf{StaticInitialization3}

    \textbf{StringFormatter1}

    \textbf{StringToCharArray1}

    \subsubsection{Miscellaneous Android-Specific}
    \textbf{Parcel1}
    \textbf{PrivateDataLeak1}
    \textbf{PublicAPIField2}
