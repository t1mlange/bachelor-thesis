...
\begin{document}
    ...
    \code{equalsTest} and \code{hashCodeTest} are expected to return one leak, but the backward analysis does report no leaks. 
    ...
    We used the newest commit on develop at the time of writing\footnotemark{} to validate our implementation.
